...
export function generateMetadata(): Metadata {
  return createPageMetadata({
    ...
    description:
      'Request your free roofing quote from ProTech Roofing. Licensed across nine states. Roof replacement, storm damage, and insurance-claim assistance. $0 down financing. Call (866) 308-2640.',
    path: '/get-quote',
  });
}
