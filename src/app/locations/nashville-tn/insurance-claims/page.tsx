...
const location = getLocationByCityStateSlug('nashville-tn');
const service = getServiceBySlug('insurance-claims');
const cityService = getCityServiceData('nashville-tn', 'insurance-claims');
...
export default function Page() {
  ...
  const siblingServices = CITY_SERVICE_SLUGS
    ...
    .map((s) => {
      ...
      return svc ? { name: svc.name, slug: svc.slug, cityStateSlug: 'nashville-tn' } : null;
    })
