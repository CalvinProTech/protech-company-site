...
const location = getLocationByCityStateSlug('jacksonville-fl');
const service = getServiceBySlug('roof-inspection');
const cityService = getCityServiceData('jacksonville-fl', 'roof-inspection');
