...
const location = getLocationByCityStateSlug('louisville-ky');
const service = getServiceBySlug('insurance-claims');
const cityService = getCityServiceData('louisville-ky', 'insurance-claims');
...
export default function Page() {
  ...
  const siblingServices = CITY_SERVICE_SLUGS
    ...
    .map((s) => {
      ...
      return svc ? { name: svc.name, slug: svc.slug, cityStateSlug: 'louisville-ky' } : null;
    })
