...
const location = getLocationByCityStateSlug('atlanta-ga');
const service = getServiceBySlug('roof-replacement');
const cityService = getCityServiceData('atlanta-ga', 'roof-replacement');
...
export default function Page() {
  ...
  const siblingServices = CITY_SERVICE_SLUGS
    ...
    .map((s) => {
      ...
      return svc ? { name: svc.name, slug: svc.slug, cityStateSlug: 'atlanta-ga' } : null;
    })
