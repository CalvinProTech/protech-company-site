/**
 * SVG path data for ProTech's 9 IS service-area states + DC.
 * Coordinates are from the standard Wikipedia Blank_US_Map (CC BY-SA 3.0)
 * — viewBox 0 0 959 593. The map displays this slice via viewBox 640 130 320 470.
 */
...
// District of Columbia is a circle in the source map (too small to draw as a path)
export const DC_CIRCLE = { cx: 822.5, cy: 244.5, r: 4, slug: "washington-dc" } as const;
