...
const services: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      {
        question:
          'Should I file an insurance claim for storm damage to my roof?',
        answer:
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question:
          'What is the best roofing material for a commercial building?',
        answer:
  ...
  },
  {
    ...
    faqs: [
      {
        question:
          'Does ProTech Roofing charge a fee to help with my insurance claim?',
        answer:
      ...
      {
        question:
          'Can I choose my own contractor or does my insurance company assign one?',
        answer:
      ...
      {
        question:
          'Does ProTech Roofing charge anything for the insurance claim inspection?',
        answer:
